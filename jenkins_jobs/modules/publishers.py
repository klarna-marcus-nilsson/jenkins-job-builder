...
def stash(parser, xml_parent, data):
    ...
    :arg string include-build-number-in-key: Include build number in key (Default: False)
    Example::
    ...
    mappings = [('server-base-url', 'stashServerBaseUrl', ""),
                ...
                ('include-build-number-in-key', 'includeBuildNumberInKey', False)]
    ...
    top = XML.SubElement(xml_parent, 'org.jenkinsci.plugins.stashNotifier.StashNotifier')
    handle_entity_children(data, top, mappings)
